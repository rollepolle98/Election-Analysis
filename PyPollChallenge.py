...
file_to_load = os.path.join("/Users/nicksbigmac/Downloads/election_results.csv")
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes_dict:
        ...
        if (county_votes > largest_county_voter_turnout) :
            largest_county_voter_turnout = county_votes
            county_winning_candidate = county_name
            county_winning_percentage = county_votes_percentage

    # 7: Print the county with the largest turnout to the terminal.
    winning_county_summary = (
        f"-------------------------\n"
        f"Largest County Turnout: {county_winning_candidate}\n"
        f"-------------------------\n")
